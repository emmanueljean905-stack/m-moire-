...
app.get('/api/debug-env', (req, res) => {
    ...
    // Lister TOUS les noms de variables (pas leurs valeurs) pour voir ce que Railway injecte
    ...
    res.json({
        ...
        // TOUS les noms de variables injectees par Railway (cle uniquement, pas les valeurs)
        TOUTES_LES_CLES: allKeys.join(' | '),
    });
});
